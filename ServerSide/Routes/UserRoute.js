...
const {
    updateProfilePhoto, deleteAcc, updateUserProfile, getAllUsersCount, registerCourse,
    getUserCourses, dropCourse, getInstructors, getInstructorsCount, getAllUsers, deleteUser, assignInstructor
